...
import com.example.embadedproject.cal.WeatherInfo.Weather;
...
public class OneDayData {
    ...
    public OneDayData() {
        ...
        this.dayMoneyinfo = Tab1Fragment.dm;
    ...
    public DayMoneyinfo getDayMoneyinfo() {
        return this.dayMoneyinfo;
    }

    public void setDayMoneyinfo(DayMoneyinfo dayMoneyinfo) {
        this.dayMoneyinfo = dayMoneyinfo;
    }
}
